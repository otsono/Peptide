...
function update() {
	if (!m_hazardsSpawned) {
		...
		if (chars.length > 0) {
			...
			if (_hz1 != null) { _hz1.setX(686.7); _hz1.setY(1648.3); }
			...
			if (_bg0 != null) { self.getBackgroundBehindContainer().addChild(_bg0.getSprite()); }
			...
			if (_bg1 != null) { self.getBackgroundBehindContainer().addChild(_bg1.getSprite()); }
			...
			if (_bg2 != null) { self.getBackgroundBehindContainer().addChild(_bg2.getSprite()); }
			...
			if (_bg4 != null) { self.getBackgroundBehindContainer().addChild(_bg4.getSprite()); }
			...
			if (_bg5 != null) { self.getBackgroundBehindContainer().addChild(_bg5.getSprite()); }
			...
			if (_bg6 != null) { self.getBackgroundBehindContainer().addChild(_bg6.getSprite()); }
			...
			if (_bg7 != null) { self.getBackgroundBehindContainer().addChild(_bg7.getSprite()); }
			...
			if (_bg8 != null) { self.getBackgroundBehindContainer().addChild(_bg8.getSprite()); }
			...
			if (_bg9 != null) { self.getBackgroundBehindContainer().addChild(_bg9.getSprite()); }
			...
			if (_bg10 != null) { self.getBackgroundBehindContainer().addChild(_bg10.getSprite()); }
			...
			if (_bg11 != null) { self.getBackgroundBehindContainer().addChild(_bg11.getSprite()); }
			...
			if (_bg12 != null) { self.getBackgroundBehindContainer().addChild(_bg12.getSprite()); }
			...
			if (_bg13 != null) { self.getBackgroundBehindContainer().addChild(_bg13.getSprite()); }
			...
			if (_bg14 != null) { self.getBackgroundBehindContainer().addChild(_bg14.getSprite()); }
			...
			if (_bg15 != null) { self.getBackgroundBehindContainer().addChild(_bg15.getSprite()); }
			...
			if (_bg16 != null) { self.getBackgroundBehindContainer().addChild(_bg16.getSprite()); }
			...
			if (_bg17 != null) { self.getBackgroundBehindContainer().addChild(_bg17.getSprite()); }
			...
			if (_bg18 != null) { self.getBackgroundBehindContainer().addChild(_bg18.getSprite()); }
			...
			if (_bg19 != null) { self.getBackgroundBehindContainer().addChild(_bg19.getSprite()); }
			...
			if (_bg20 != null) { self.getBackgroundBehindContainer().addChild(_bg20.getSprite()); }
			...
			if (_bg21 != null) { self.getBackgroundBehindContainer().addChild(_bg21.getSprite()); }
			...
			if (_bg22 != null) { self.getBackgroundBehindContainer().addChild(_bg22.getSprite()); }
			...
			if (_bg23 != null) { self.getBackgroundBehindContainer().addChild(_bg23.getSprite()); }
			...
			if (_bg24 != null) { self.getBackgroundBehindContainer().addChild(_bg24.getSprite()); }
			...
			if (_bg25 != null) { self.getBackgroundBehindContainer().addChild(_bg25.getSprite()); }
			...
			if (_bg26 != null) { self.getBackgroundBehindContainer().addChild(_bg26.getSprite()); }
			...
			if (_bg27 != null) { self.getBackgroundBehindContainer().addChild(_bg27.getSprite()); }
			...
			if (_bg28 != null) { self.getBackgroundBehindContainer().addChild(_bg28.getSprite()); }
			...
			if (_bg29 != null) { self.getBackgroundBehindContainer().addChild(_bg29.getSprite()); }
			...
			if (_bg30 != null) { self.getBackgroundBehindContainer().addChild(_bg30.getSprite()); }
			...
			if (_bg31 != null) { self.getBackgroundBehindContainer().addChild(_bg31.getSprite()); }
			...
			if (_bg32 != null) { self.getBackgroundBehindContainer().addChild(_bg32.getSprite()); }
			...
			if (_bg33 != null) { self.getBackgroundBehindContainer().addChild(_bg33.getSprite()); }
			...
			if (_bg34 != null) { self.getBackgroundBehindContainer().addChild(_bg34.getSprite()); }
		}
	}
}
function onTeardown() {}
