...
**special case -- the Fraymakers/HashLink engine.** at Team Fray's request, two
things must **not** show up in the tracked repo: (1) how to **decompile or patch** the
...
format notes aren't affected. details: [`AGENT_CONTEXT.md`](AGENT_CONTEXT.md) "engine-side
...
**the one exception:** Fraymakers/HashLink engine and FrayTools RE notes (see the "special
