...
// limb values inferred from move type — review before use.
{
	...
	dash_attack: {
		hitbox0: { damage: 14, angle: 70, baseKnockback: 40, knockbackGrowth: 125, hitstop: 12, selfHitstop: -1, limb: AttackLimb.FIST },
		hitbox1: { damage: 14, angle: 70, baseKnockback: 40, knockbackGrowth: 125, hitstop: 12, selfHitstop: -1, limb: AttackLimb.FIST },
	},
	tilt_forward: {
	...
	tilt_down: {
		hitbox0: { damage: 10, angle: 70, baseKnockback: 90, knockbackGrowth: 50, hitstop: 10, selfHitstop: -1, hitstun: 0, limb: AttackLimb.FOOT },
	},
	...
	strong_up_attack: {
		hitbox0: { damage: 8, angle: 90, baseKnockback: 130, knockbackGrowth: 50, hitstop: 10, selfHitstop: -1, limb: AttackLimb.FIST },
	},
	strong_down_attack: {
	...
	//AERIAL ATTACKS
	aerial_neutral: {
		hitbox0: { damage: 11, angle: 45, baseKnockback: 22, knockbackGrowth: 85, hitstop: 8, selfHitstop: -1, limb: AttackLimb.FOOT },
	},
	aerial_forward: {
		hitbox0: { damage: 11, angle: 30, baseKnockback: 30, knockbackGrowth: 110, hitstop: 14, selfHitstop: -1, limb: AttackLimb.FOOT },
	},
	aerial_back: {
		hitbox0: { damage: 9, angle: 66, baseKnockback: 30, knockbackGrowth: 90, hitstop: 10, selfHitstop: -1, limb: AttackLimb.FOOT },
	},
	aerial_up: {
		hitbox0: { damage: 9, angle: 90, baseKnockback: 50, knockbackGrowth: 55, hitstop: 6, selfHitstop: -1, limb: AttackLimb.FOOT },
	},
	aerial_down: {
	...
	//SPECIAL ATTACKS
	special_neutral: {
		hitbox0: { damage: 0, angle: 0, baseKnockback: 0, knockbackGrowth: 1, hitstop: 2, selfHitstop: -1, hitstun: 0, limb: AttackLimb.FOOT },
	},
	special_neutral_air: {
		hitbox0: { damage: 0, angle: 0, baseKnockback: 0, knockbackGrowth: 1, hitstop: 2, selfHitstop: -1, hitstun: 0, limb: AttackLimb.FOOT },
	},
	special_side: {
		hitbox0: { damage: 7, angle: 35, baseKnockback: 60, knockbackGrowth: 100, hitstop: 8, selfHitstop: -1, hitstun: 0, limb: AttackLimb.FIST },
	},
	special_side_air: {
		hitbox0: { damage: 7, angle: 35, baseKnockback: 60, knockbackGrowth: 100, hitstop: 8, selfHitstop: -1, hitstun: 0, limb: AttackLimb.FIST },
	},
	...
	throw_down: {
		...
		hitbox1: { damage: 4, angle: 90, baseKnockback: 40, knockbackGrowth: 60, hitstop: 6, selfHitstop: -1, hitstun: 0, limb: AttackLimb.BODY },
	},
	throw_forward: {
		hitbox0: { damage: 3, angle: 45, baseKnockback: 60, knockbackGrowth: 100, hitstop: -1, selfHitstop: -1, hitstun: 0, limb: AttackLimb.BODY },
	...
	// SSF2: special: {
		hitbox0: { damage: 0, angle: 0, baseKnockback: 0, knockbackGrowth: 0, hitstop: 198, selfHitstop: -1, hitstun: 0, limb: AttackLimb.FIST },
	},
}
