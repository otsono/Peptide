...
// NOT to add it to an allow-list. The list is shared with the code-comment
// trip-wire (conventions.rs) -- it lives in `common::ENGINE_SYMBOL_NEEDLES` so a
...
fn no_engine_internals_in_tracked_docs() {
    ...
    for doc in TRACKED_DOCS {
        ...
        for needle in common::ENGINE_SYMBOL_NEEDLES {
